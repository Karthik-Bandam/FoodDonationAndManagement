...
Geocode.setApiKey("AIzaSyCnWGOyXzQIw5E3L1HNb-1gRWe3djbI9gI");
Geocode.enableDebug();
...
class Map extends Component {
	...
	onMarkerDragEnd = (event) => {
		...
		this.props.mapValueFunc(this.address);
	};
	...
	render() {
		...
		if (this.props.center.lat !== undefined) {
			map = <div>
				...
				<AsyncMap
				googleMapURL={`https://maps.googleapis.com/maps/api/js?key=${"AIzaSyCnWGOyXzQIw5E3L1HNb-1gRWe3djbI9gI"}&libraries=places`}
					loadingElement={
